...
The `-b` flag indicates that we would like to use the ROS Indigo specific branch of their respository. The default branch for the project is currently only for ROS Jade.
